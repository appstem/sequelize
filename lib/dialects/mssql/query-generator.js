...
var QueryGenerator = {
  ...
  addLimitAndOffset: function(options, model) {
    ...
    if (options.limit || options.offset) {
      if (!options.order || (options.include && !orders.subQueryOrder.length && !options.order.find(orderItem => orderItem == model.primaryKeyField || (Array.isArray(orderItem) && orderItem[0] == model.primaryKeyField)))) {
